...
// Pre-calculated constants for MSVC compatibility
#define XI0_RAD   (-8.0621359223734315e-08)     ///< XI0 in radians
#define ETA0_RAD  (-3.3040311174456547e-08)     ///< ETA0 in radians  
#define DA0_RAD   (-7.0740570056930297e-08)     ///< DA0 in radians
...
static int set_frame_tie(novas_frame *frame) {
  ...
  const double ax = ETA0;
  const double ay = -XI0;
  const double az = -DA0;
  const double X = ax * ax;
  const double Y = ay * ay;
  const double Z = az * az;
