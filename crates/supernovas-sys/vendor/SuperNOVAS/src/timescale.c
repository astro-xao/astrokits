...
#ifdef _WIN32
// Windows/MSVC compatibility for case-insensitive string comparison
 ...
 * @sa julian_date()
 */
double novas_parse_date_format(enum novas_calendar_type calendar, enum novas_date_format format, const char *date,
        char **tail) {
 ...
 * @sa novas_parse_date()
 */
double novas_parse_iso_date(const char *date, char **tail) {
 ...
 * @sa novas_iso_timestamp()
 */
double novas_date(const char *date) {
 ...
 * @sa novas_timestamp()
 */
double novas_date_scale(const char *date, enum novas_timescale *scale) {
 ...
 * @sa novas_print_timescale()
 */
enum novas_timescale novas_parse_timescale(const char *str, char **tail) {
 ...
 * @sa novas_set_time()
 */
double novas_time_gst(const novas_timespec *time, enum novas_accuracy accuracy) {
 ...
 * @sa novas_set_time()
 */
double novas_time_lst(const novas_timespec *time, double lon, enum novas_accuracy accuracy) {
