...
static int cat_to_icrs(cat_entry *star, const char *system) {
 ...
 * @author Attila Kovacs
 */
int make_cat_object_sys(const cat_entry *star, const char *system, object *source) {
 ...
 * @author Attila Kovacs
 */
int make_redshifted_object_sys(const char *name, double ra, double dec, const char *system, double z, object *source) {
