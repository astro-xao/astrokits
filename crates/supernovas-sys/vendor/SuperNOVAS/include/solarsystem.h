...
short earth_sun_calc_hp(const double jd_tdb[2], enum novas_planet body, enum novas_origin origin,
        double *position, double *velocity);
...
short planet_eph_manager_hp(const double jd_tdb[2], enum novas_planet body, enum novas_origin origin,
        double *position, double *velocity);

short planet_jplint(double jd_tdb, enum novas_planet body, enum novas_origin origin, double *position,
        double *velocity);
...
int novas_orbit_posvel(double jd_tdb, const novas_orbital *orbit, enum novas_accuracy accuracy,
...
// in orbit.c
int novas_orbit_native_posvel(double jd_tdb, const novas_orbital *orbit, double *pos, double *vel);

// in plorbit.c
int novas_make_planet_orbit(enum novas_planet id, double jd_tdb, novas_orbital *orbit);

int novas_make_moon_orbit(double jd_tdb, novas_orbital *orbit);

int novas_approx_heliocentric(enum novas_planet id, double jd_tdb, double *pos, double *vel);

int novas_approx_sky_pos(enum novas_planet id, const novas_frame *frame, enum novas_reference_system sys, sky_pos *out);
